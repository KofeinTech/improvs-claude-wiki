...
Everything you need to start working with Claude Code at Improvs.
...
| [Tips and Tricks](tips-and-tricks.md) | Plan mode, permissions, context management, power-user tips |
...
Claude Code generates code. You review every line, validate the logic, and take responsibility for what gets committed. Never auto-commit. Never trust blindly.
